...
class Question(models.Model):
    ...
    # question page formating in admin
    was_published_recently.admin_order_field = 'pub_date' # sort colunm based on pub_date
    was_published_recently.boolean = True                 # Icon
    was_published_recently.short_description = 'Published recently?' # column Heading
